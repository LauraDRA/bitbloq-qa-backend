...
describe('Compiler test', function() {
    ...
    it('bbb-323:Compile a correct code',function() {
        request.post('/compile',200,compile.correctCode);
        request.post('/compile',200,compile.correctCodebt328);
        return chakram.wait();
    });

    it('bbb-324:Compile an incorrect correct',function() {
        return request.post('/compile',200,compile.incorrectCode).then(function(response1) {
            expect(response1).to.comprise.of.json(compile.errorNoFile);
            return request.post('/compile',200,compile.incorrectCodebt328).then(function(response2) {
    ...
    it('bbb-325:Compile a code without BOARD',function() {
        return request.post('/compile',400,compile.codeWithoutBoard).then(function(response) {
    ...
    it('bbb-326:Compile a code without CODE',function() {
        return request.post('/compile',400,compile.codeWithoutCode).then(function(response) {
          expect(response.body).to.equal(compile.errorBoardorCode);
          return request.post('/compile',400,compile.codeWithoutCodebt328).then(function(response2) {
    ...
    it('bbb-327:Compile a code without CODE and without BOARD',function() {
        return request.post('/compile',400,{}).then(function(response) {
          expect(response.body).to.equal(compile.errorBoardorCode);
          return chakram.wait();
        });
    });
    ...
    it('bbb-328:Compile a code with an incorrect BOARD',function() {
        return request.post('/compile',400,compile.codeWithBoardIncompatible).then(function(response) {
    ...
    it('bbb-329:Compile a code twice',function() {
        return request.post('/compile',200,compile.correctCode).then(function(response) {
          return request.post('/compile',200,compile.correctCode).then(function(response2){
    ...
    it('bbb-330:Compile different codes',function() {
        return request.post('/compile',200,compile.correctCode).then(function(response) {
            return request.post('/compile',200,compile.correctCodeDiff).then(function(response2) {
